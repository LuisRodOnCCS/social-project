    ...
    <x-slot name="form">
        ...
        <div class="w-md-75">
            ...
            <div class="mb-3">
                ...
                {{-- <x-jet-input id="twitter" type="twitter" class="{{ $errors->has('twitter') ? 'is-invalid' : '' }}" wire:model.defer="state.twitter" /> --}}
                <x-jet-input id="twitter" type="twitter" class="{{ $errors->has('twitter') ? 'is-invalid' : '' }}" wire:model.defer="state.socialmedia" />
                <x-jet-input-error for="twitter" />
            </div>
            
            <div class="mb-3">
                <x-jet-label for="github" value="{{ __('Github') }}" />
                {{-- <x-jet-input id="github" type="github" class="{{ $errors->has('github') ? 'is-invalid' : '' }}" wire:model.defer="state.github" /> --}}
                <x-jet-input id="github" type="github" class="{{ $errors->has('github') ? 'is-invalid' : '' }}" wire:model.defer="state.socialmedia" />
